...
public class LinkedList<AnyType extends Comparable<? super AnyType>> implements List<AnyType> {
    ...
    private Node<AnyType> getNode(int index) throws IndexOutOfBoundsException {
        ...
        /**
         * -------------------------------------------
         * TODO: Check for valid index and throw IndexOutOfBounds exception if
         *    necessary.
         *    
         *    Fix this method so that it is more efficient by
         *    traversing from front/head if index is nearer front and
         *    traversing from back/tail if index nearer tail
         *       -- currently it traverses from front
         *          * 
